...
(function () {
    ...
    window.showResetForm = function (e) {
        ...
        popup.innerHTML =
            ...
            + '<input type="email" id="rst-email" placeholder="info@hosu.or.ug" style="width:100%;padding:0.45rem 0.65rem;border:1.5px solid #d1d5db;border-radius:6px;font-size:0.82rem;margin-bottom:0.4rem;font-family:inherit;">'
